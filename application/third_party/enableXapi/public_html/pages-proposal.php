				...
				<div class="card-wrap blogs-content col col-m-12 col-t-12 col-d-12 col-d-lg-12">
						...
						<div class="content inner-top">
							<div class="row">
								<div class="col col-m-12 col-t-12 col-d-12 col-d-lg-12">
									<div class="title-bg">Keynote Speaking</div>
								</div>
							</div>
						</div>
							...
							<div class="row" >
									...
									<form method="POST" action="" id="contactForm">
										<div class="col col-m-11 col-t-11 col-d-10 col-d-lg-10" style="margin-left:5%; margin-right:5%;">
												...
												<input type="text" class="formgroup fiftyPercent" value="<?php echo $_POST['facilitator']; ?>" name="facilitator" placeholder="Facilitator" required />
												<input type="text" class="formgroup fiftyPercent" value="<?php echo $_POST['offer']; ?>" name="offer" placeholder="offering" required />
												<select class="formgroup fiftyPercent" name="title" style="background: transparent; border:none !important; border-bottom: 1px solid #777777 !important; color:#697161;" required>
												...
												<input type="hidden" value="inHouse" name="action" required />
												<input type="hidden" value="<?php echo $programme;?>" name="type" required />
												<input type="text" class="formgroup fiftyPercent"  name="audience" placeholder="Audience Profile" required />

												<input type="text" class="formgroup fiftyPercent" name="time" placeholder="Suggest Time" required />
												<input type="date" class="formgroup fiftyPercent"  name="date" placeholder="Suggest Date" required />
												...
												<input type="text" class="formgroup fiftyPercent"  name="suggestedPlace" placeholder="Suggest Place of delivery" style="width:100% !important;" required />
					...
					<div class="card-wrap blogs-content col col-m-12 col-t-12 col-d-12 col-d-lg-12">
						...
						<div class="content inner-top">
							<div class="row">
								<div class="col col-m-12 col-t-12 col-d-12 col-d-lg-12">
									<div class="title-bg">Coaching</div>
								</div>
							</div>
						</div>
					...
					<div class="card-wrap blogs-content col col-m-12 col-t-12 col-d-12 col-d-lg-12">
						...
						<div class="content inner-top">
							<div class="row">
								<div class="col col-m-12 col-t-12 col-d-12 col-d-lg-12">
									<div class="title-bg">Proposal</div>
								</div>
							</div>
						</div>
						...
						<div class="content blog">
							...
							<div class="row" >
									...
									<form method="POST" action="" id="contactForm">
										<div class="col col-m-11 col-t-11 col-d-10 col-d-lg-10" style="margin-left:5%; margin-right:5%;">
												<input type="text" class="formgroup fiftyPercent" max="50" value="<?php echo $_POST['ename'];?>" name="programme" placeholder="Programme" required />
												<input type="number" class="formgroup fiftyPercent" max="50" name="participants" placeholder="Number of Number of Participants" required />
												...
												<input type="text" class="formgroup fiftyPercent" name="time" placeholder="Suggest Time" required />
												<input type="date" class="formgroup fiftyPercent"  name="date" placeholder="Suggest Date" required />
												<input type="date" class="formgroup fiftyPercent"  name="deliveryPlace" placeholder="Suggest Place of Delivery" required />
												<input type="text" class="formgroup fiftyPercent" name="city" placeholder="City / Town"  required />
												<select class="formgroup fiftyPercent" name="country" style="background: transparent; border:none !important; border-bottom: 1px solid #777777 !important; color:#697161;">
															<option value="">Please Select Country</option>
															<option value="Afghanistan">Afghanistan</option>
