					...
					<div class="card-wrap blogs-content col col-m-12 col-t-12 col-d-12 col-d-lg-12">
						...
						<div class="content inner-top">
							<div class="row">
								...
								<!--a href="events.php" class="btn2" style="height: 30%; font-size: 12px; background-color: #318342; margin-left: 10rem; padding: 8px 8px; border-radius: 5px;">Public Training</a-->	
								...
								<div class="col col-m-10 col-t-8 col-d-8 col-d-lg-8" style="text-align: left;font-size: 16px;margin-top: 4rem;">
									<p style="margin-top: 2rem;"><center>Our public training sessions are delivered through public, teambuilding activities, boot camps or weekend getaways for corporate, informal group, schools and individuals. 
									</center></p>
								</div>
				...
				<!-- 	<div class="card-wrap blogs-sidebar col col-m-12 col-t-12 col-d-3 col-d-lg-3">
						<aside id="secondary" class="widget-area">
							...
							<div class="widget widget_recent_entries">
								...
								<br>
								<h2 class="widget-title" style="color: #34373a">InHouse Events</h2>
								<ul>
									<li>
							...
							<div class="widget widget_recent_comments">
								<h2 class="widget-title" style="color: #34373a">Podcast</h2>
							...
							<div class="widget widget_archive" style="display: flex;justify-content: space-between;">
								
							
								<a href="#" style="font-size: 12px; color: #fff; background-color: green;padding: .5rem 1rem; font-weight: 200">Register your event</a>&nbsp;&nbsp;
								<a href="#" style="font-size: 12px; color: #fff; background-color: green;padding: .5rem 1rem;font-weight: 200">register as a Facilitactor</a>
...
function getCountry($con){
	...
	$sql = "SELECT DISTINCT seminarOffering FROM ngomaSeminars; 
	";
	$data =  "";
