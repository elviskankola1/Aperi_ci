...
<html lang="en">
  ...
  <section id="container" >
      ...
      *********************************************************************************************************************************************************** -->
      <!--main content start-->
          ...
          <section class="wrapper site-min-height">
            <h3>Advisory Board</h3><button class="btn btn-primary btn-sm" data-toggle="modal" data-target="#myModal" style="margin-bottom:20px;">Add Advisor </button>
              ...
              <div class="modal-dialog">
                <div class="modal-content">
                  <div class="modal-header">
                   ...
                   <form class="submitForm">
                  <div class="modal-body" id="editAdvisors">
    ...
    <script>
      ...
      $(document).on('click', '.editAdvisor', function(){
    ...
    $(document).on('click', '.deletAdvisor', function(){
          var val = $(this).data('id');
          var action = "deleteAdvisor";
          var img = $(this).data('img');
          var query = confirm("Are you sure you want to delete this Advisor");
           if (query == true) {
           $.ajax({
                type:"POST",
                url:"php core/advisors.php",
