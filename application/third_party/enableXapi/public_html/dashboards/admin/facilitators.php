  ...
  <section id="container" >
              ...
              <div class="modal-dialog">
                <div class="modal-content">
                  <div class="modal-header">
                   ...
                   <form class="submitForm">
                  <div class="modal-body" id="editFacilitators">
    ...
    <script>
      $(document).ready(function(){
       ...
       $(document).on('click', '.editFacilitator', function(){
          ...
          var action = "fetchEditForm";
           $.ajax({
                ...
                success:function(data){
                  $('#editFacilitators').html(data);
                }
              });
        });

    $(document).on('click', '.deleteFacilitator', function(){
          var val = $(this).data('id');
          var action = "deleteFacilitator";
