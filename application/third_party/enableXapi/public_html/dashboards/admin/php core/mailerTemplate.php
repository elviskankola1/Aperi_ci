...
$messageTwo = "";
  $messageTwo =  '
      ...
      <p style="text-align:right; position:relative; top:-60px !important;">
      <b><img src="https://cdn1.iconfinder.com/data/icons/instagram-ui-flat/48/Instagram_UI-19-512.png" class="img-icons" style=" background:#ff0000; ">Leading Yourself </i></b> 
      <b><img src="https://cdn1.iconfinder.com/data/icons/instagram-ui-flat/48/Instagram_UI-19-512.png" class="img-icons" style="background:blue;">Leading People</b> 
      <b><img src="https://cdn1.iconfinder.com/data/icons/instagram-ui-flat/48/Instagram_UI-19-512.png" class="img-icons" style=" background:#4caf50;">Leading Organisations</b> <br><br>
       </p>
      <div id="container" >
      <p style="text-align:left; line-height:15px;">
      To:  <br>'.CheckData($_POST['name']).'<span style="float:right;"> '.CheckData($_POST['town']).', '.CheckData($_POST['date']).'</span><br>
     ...
     '.CheckData($_POST['town']).'<br><br>
       <b>RE: '.CheckData($_POST['subject']).'</b>
      <hr><br>

    <h4>Dear '.CheckData($_POST['name']).' </h4>
    '.nl2br(CheckData($_POST['message'])).'
      <h4>'. CheckData($_POST['senderName']).'</h4>
      <p style="margin-top:-10px !important;">'.CheckData($_POST['senderPosition']).'</p> 
      <br>
      <table>
        <tr>
        <tr>
