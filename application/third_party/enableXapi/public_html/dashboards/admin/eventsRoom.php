      ...
      *********************************************************************************************************************************************************** -->
      ...
      <section id="main-content">
         ...
         <?php 
                  ...
                  if($_GET['room']){
                    echo "<div class='alert alert-success'>Virtual Event Room succesfully created! Please check your email for login details and Participants login details</div>";
            ...
            <div class="col-lg-12 col-md-6 col-sm-12" >
             ...
             <div class="content-panel" style="background-color:white;">
                      ...
                      $sql = "SELECT * FROM classRoom inner join ngomaFacilitators on classRoom.facilitatorID = ngomaFacilitators.facilitatorID";
                                            $query = mysqli_query($con,$sql);
                                            $num =1;
                                            while ($row = mysqli_fetch_array($query)){ ?>
                                             <tr>
                                               <td><?php echo $num++?></td>
                                                 ...
                                                 <td><a href="../../live/">Join session</a></td>
                                                 <td>
                                       <a onclick="change('Are you sure you want to delete this?')" href="eventsRoom.php?id=<?php echo $row['Id']?>">
                          ...
                          <div class="col-sm-6">
                            <div class="form-group">
                              <label>Event Country</label>
                                <select class="form-control" name="seminarCountry"> 
