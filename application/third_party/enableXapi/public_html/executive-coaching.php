					...
					<div class="blogs-content col col-m-12 col-t-12 col-d-12 col-d-lg-12">
						...
						<div class="content inner-top">
							<div class="row">
								...
								<a href="events.php" class="btn2" style="height: 30%; font-size: 12px; background-color: #318342; padding: 8px 8px; border-radius: 5px;">Open Seminar</a>	
								...
								<a href="in-house.php" class="btn2" style="height: 30%; font-size: 12px; background-color: #318342; margin-left: 10rem;padding: 8px 8px; border-radius: 5px;">In-House Events</a>
								</div>	
									<div class="title-bg mobile1" style="margin-top: 5rem;">Executive Coaching</div>
								</div>
							</div>
						</div>
									...
									<div class="box-item card-box">
										...
										<div class="desc">
											<form action="facilitators.php" method="post">
												...
												<input type="submit" class="name book-button" style="font-weight: 200; border-bottom: none !important; cursor: pointer;" value="View Coaches & Select">
												</div>		
											</form>
										</div>
