...
<head>
	...
	<title>Partners | Ngoma Communications</title>
					...
					<div class="blogs-content col col-m-12 col-t-12 col-d-12 col-d-lg-12">
						...
						<div class="content blog" style="margin-top: 30px">
							...
							<div class="row">
								...
								$profile_img = "";
								$sql = "SELECT * FROM csrPartnerships WHERE csrpartnerID ='".$partner."' ";
					            $result = mysqli_query($con, $sql);
					            $queryResult = mysqli_num_rows($result);  

					            if($queryResult > 0 ){
					            while ($row = mysqli_fetch_array($result)){
					            	$partner = $row['csrPartnerName'];
					            	$description = $row['csrPartnerBio'];
					            	 if ($row['csrPartnerImg'] != "") {
					            	 	$profile_img ='<img style="max-height: 500px; width:auto;"  src="about/images/csr/'.$row['csrPartnerImg'].'"/>';
					            	 }else{about/
					            	 	$profile_img = '<img src="https://cdn.pixabay.com/photo/2015/10/05/22/37/blank-profile-picture-973460_960_720.png"/>';
					            	 }
							...
							<div class="col col-m-12 col-t-12 col-d-4 col-d-lg-4">
									<div class="box-item card-box">
										...
										<div class="desc">
											<p style="font-size: 20px"><?php echo $partner ; ?></p>		
										</form>	
										</div>
								...
								<div class="col col-m-12 col-t-12 col-d-8 col-d-lg-8">
									<div class="box-item card-box" style="text-align: left; padding: 3%">
										<div class="desc">
											<a class="name" style="font-size: 20px; font-weight: 200"><?php  echo nl2br($description) ; ?></a>
										</div>
