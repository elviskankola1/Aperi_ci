<div class="form-body">
    <form action="tokens/index" method="POST">
        <div class="row">
                ...
                <div class="form-content" >
                    <div class="form-items" style="margin-top: 6rem;">
                        ...
                        <div class="page-links">
                            ...
                            <a href="<?= base_url()?>rooms">Create Room</a>
                        </div>
                         <input class="form-control" type="text" id="nameText" name="nameText" placeholder="Enter Name"  required>
                         <input class="form-control" type="text" id="roomName" name="meetingID" placeholder="Room ID" value="<?php if (isset($_GET['id'])) echo $_GET['id'];?>" required>
                        <input class="form-control" type="text" id="room" name="roomPin" placeholder="Enter your Pin" value="<?php if (isset($_GET['roomPin'])) echo $_GET['roomPin'];?>" required style="color: #000 !important;">
